        ...
        <div className="inline-flex rounded-full border border-white/10 bg-white/5 p-1">
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-semibold transition ${
              !annualBilling ? 'bg-white text-slate-950' : 'text-slate-300 hover:text-white'
            }`}
          >
            Monthly
          </button>
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-semibold transition ${
              annualBilling ? 'bg-surge text-slate-950' : 'text-slate-300 hover:text-white'
            }`}
          >
            Annual
          </button>
        ...
        {plans.map((plan) => (
          <SectionReveal
            ...
            className={`rounded-[30px] border p-8 transition duration-300 hover:-translate-y-1 ${
              plan.featured
                ? 'border-surge/40 bg-gradient-to-b from-surge/10 to-white/5 shadow-glow'
          ...
          >
            <div className="flex items-center justify-between">
              ...
              {plan.featured ? (
                <span className="rounded-full bg-surge px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-slate-950">
                  Popular
                </span>
              ) : null}
            </div>
            ...
            <Link
              ...
              className={`mt-8 inline-flex w-full justify-center rounded-full px-5 py-3 text-sm font-semibold transition ${
                plan.featured
                  ? 'bg-surge text-slate-950 hover:bg-teal-300'
